...
<div class="main" id="main">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mobile-logo text-center">
                            <a href=<?= menu(MenuHome) ?>><img alt="" class="img-fluid"
            ...
            <div class="row justify-content-between">
                <div class="col-lg-9 pl-0">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        <a class="navbar-brand" href=<?= menu(MenuHome) ?>><img alt="" class="img-fluid"
                                                                                src="Assets/images/header-logo.png"></a>
                        <!-- Logo End -->
                                ...
                                <div class="nav-account ml-2">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right fade-up">
                                            ...
                                            <!-- Li 2 end -->
                                            <li>
                                                <a style="cursor:pointer;" id="trailer" class="dropdown-item"
                                                   tabindex="0" data-toggle="modal" data-target="#logout-tab"
                                                   aria-hidden="true">Chiqish</a>
    ...
    <!-- Modal Trailer -->
    <div class="modal fade" id="logout-tab" tabindex="0" role="dialog" aria-labelledby="trailer-modal"
         aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document" id="trailerModal">
            ...
            <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-6">
                        <a class="btn hvr-sweep-to-right ok-btn" href=<?= menu(MenuLogout) ?> tabindex="0"><i
                                    aria-hidden="true" class="fa fa-play mr-2"></i>Chiqish</a>
                    </div>
                    <div class="col-6">
                        <a data-dismiss="modal" aria-label="Close" class="btn close-btn hvr-sweep-to-right"
                           tabindex="0"><i aria-hidden="true" class="fa fa-play mr-2"></i>Bekor Qilish</a>
                    </div>
                </div>
