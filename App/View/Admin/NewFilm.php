...
<div class="container-fluid pt-4 px-4">
    ...
    <div class="col-sm-12 col-xl-12">
        <div class="bg-secondary rounded h-100 p-4">
            <div id="ErrorContainer" style="display: none;width:100%;" class="alert alert-primary alert-dismissible fade show" role="alert">
            ...
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">Yangi Film</button>
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">Serial Davomi</button>
                    </div>
                </nav>
                <div class="tab-content pt-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        ...
                        <div class="row">
                            <!-- select  -->
                            <div class="col-6">
                                <select id="FilmRating" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                            ...
                            <div class="col-6">
                                <select id="FilmJanr" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <select id="FilmState" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                            ...
                            <div class="col-6">
                                <select id="FilmYoung" class="form-select form-select-sm mb-3" aria-label=".form-select-sm example">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="FilmYear" id="floatingInput" placeholder="Flesh | O'zbek Tilida">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="FilmName" id="floatingInput" placeholder="Flesh | O'zbek Tilida">
                            <label for="floatingInput">Film Nomi</label>
                        </div>


                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="FilmUrl" id="floatingInput" placeholder="Flesh | O'zbek Tilida">
                            <label for="floatingInput">Film Url</label>
                        </div>

                        <div class="form-floating">
                            <textarea class="form-control" name="FilmCaption" id="floatingTextarea" style="height: 150px;"></textarea>
                        ...
                        <div class="row">
                            ...
                            <div class="col-4"></div>
                            <div class="col-4">
                                <button style="float: right;" onclick="NewFilm()" type="button" class="btn btn-outline-success m-2">Saqlash</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="SerialID" id="floatingInput" placeholder="Flesh | O'zbek Tilida">
                                    <label for="floatingInput">Film ID (12 || 23 || 44)</label>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" name="SerialUrl" id="floatingInput" placeholder="Flesh | O'zbek Tilida">
                            ...
                            <div class="col-12">
                                <div class="form-floating mb-3">
                                    <input type="number" class="form-control" name="SerialSection" id="floatingInput" placeholder="Flesh | O'zbek Tilida">
                        ...
                        <div class="row">
                            ...
                            <div class="col-4"></div>
                            <div class="col-4">
                                <button style="float: right;" onclick="NewSerial()" type="button" class="btn btn-outline-success m-2">Saqlash</button>
                            </div>
                        </div>
    ...
    function NewFilm() {
        ...
        req.onload = () => {
            if (req.response != "ok") {
                ...
                var FilmName = document.querySelector("input[name='FilmName']").value = "";
                var FilmCaption = document.querySelector("textarea[name='FilmCaption']").value = '';
                var FilmYoung = document.querySelector("#FilmYoung").value = "Film Yosh chagarasini tanlang";
