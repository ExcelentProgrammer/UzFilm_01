    ...
    <section class="last-seasons pb-0">
        <div class="last-season"
            ...
            <div class="container-fluid">
                <h1>Kachirasiz Qidiruvga mos keladigan Film Topilmadi</h1>
            </div>
        </div>
    </section>
                                        ...
                                        <div class="video-block">
                                            <div class="video-thumb position-relative thumb-overlay">
                                                ...
                                                <div class="box-content">
                                                    <ul class="icon">
                                                        <li>
                                                            <a href=<?= __Watch($AllFilm['ID'], $type) ?>><i
                                            ...
                                            <div class="video-content">
                                                ...
                                                <div class="video-info d-flex align-items-center">
                                                    <span class="video-year"><?= $AllFilm['FilmYear'] ?></span> <span
                                                            class="video-seasons"><?= $AllFilm['FilmYoung'] ?></span>
                            ...
                            <ul class="nav nav-tabs" style="border: 0px;width: 1000px;">
                                ...
                                if ($page + 2 >= $apages) {
                                    ...
                                    <li class="nav-item ml-3 bg-info">
                                        <a class="nav-link" aria-current="page"
                                           href=<?= __Search($Search, $apages) ?>><?= $apages ?></a>
                                    </li>
                                <?php } ?>
                            </ul>
