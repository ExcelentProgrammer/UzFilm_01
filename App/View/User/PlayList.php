<?php if (!empty($MyLists['Film']) OR !empty($MyLists['Multfilm']) OR !empty($MyLists['Video'])) { ?>
                                        ...
                                        <ul class="icon">
                                            ...
                                            <li><a href=<?= __RemoveList($Film['ID'], "Film") ?>>
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                         style="background-color: white" height="8" fill="currentColor"
                            ...
                            <div class="video-block">
                                <div class="video-thumb position-relative thumb-overlay">
                                    ...
                                    <div class="box-content">
                                        <ul class="icon">
                                            <li>
                                                <a href=<?= menu(MenuWatch) . "&video_id=" . $Film['ID'] . "&type=video" ?>><i
                                                            class="fas fa-play"></i></a></li>
...
<?php } else { ?>
    <div class="row h-100-vh">
        <h1 class="mr-auto ml-auto mt-auto mb-auto">Sizda Saqlanga Filmlar mavjud Emas</h1>
    </div>
<?php } ?>