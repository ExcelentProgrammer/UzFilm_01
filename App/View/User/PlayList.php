                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <div class="video-block">
                            <div class="video-thumb position-relative thumb-overlay">
                                <a href="#"><img class="img-fluid img-tab" src=<?= "Assets/images/FilmImg/" . $Film['FilmImg'] ?> alt=""></a>
                            ...
                            <div class="video-content">
                                <h2 class="video-title"><a href=<?= menu(MenuWatch) . "&video_id=" . $Film['ID'] ?>><?= __Short($Film['FilmName'], 10) ?></a>
                                </h2>
                ...
                foreach ($MyLists['Multfilm'] as $Film) { ?>
                    ...
                    <div class="col-6 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <div class="video-block">
                            ...
                            <!-- Video Thumb End -->
                            <div class="video-content">
                                <h2 class="video-title"><a href=<?= MultfilmToWatch($Film['ID']) ?>><?= __Short($Film['FilmName'], 10) ?></a>
                                </h2>
                                <div class="video-info d-flex align-items-center">
                                    <span class="video-year"><?= $Film['FilmYear'] ?></span>
                                    <span class="video-seasons"><?= $Film['FilmYoung'] ?></span>
